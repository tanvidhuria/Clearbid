...
export const ASSISTANT_TOOLS = [
  ...
  ACTION("add_vendor_response", "Add the files the buyer attached in this message as a vendor's response (a new vendor, or a follow-up reply from an existing vendor) and read them.", { vendor: { type: "string" } }, ["vendor"]),
